...
.method protected constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p0, p1, p2}, Lfw;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0}, Lfs;->getWindow()Landroid/view/Window;

    move-result-object v0

    invoke-direct {p1, p2, p0, v0}, Landroid/support/v7/app/AlertController;-><init>(Landroid/content/Context;Lfw;Landroid/view/Window;)V

    iput-object p1, p0, Lfs;->a:Landroid/support/v7/app/AlertController;
...
.method static a(Landroid/content/Context;I)I
    ...
    sget v0, Lgc$a;->alertDialogTheme:I
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-super {p0, p1}, Lfw;->onCreate(Landroid/os/Bundle;)V

    iget-object p1, p0, Lfs;->a:Landroid/support/v7/app/AlertController;
    ...
    iget v0, p1, Landroid/support/v7/app/AlertController;->o:I
    ...
    :cond_0
    iget v0, p1, Landroid/support/v7/app/AlertController;->i:I

    :goto_0
    iget-object v2, p1, Landroid/support/v7/app/AlertController;->a:Lfw;

    invoke-virtual {v2, v0}, Lfw;->setContentView(I)V

    iget-object v0, p1, Landroid/support/v7/app/AlertController;->a:Landroid/view/Window;

    sget v2, Lgc$f;->parentPanel:I

    invoke-virtual {v0, v2}, Landroid/view/Window;->findViewById(I)Landroid/view/View;

    move-result-object v0

    sget v2, Lgc$f;->topPanel:I

    invoke-virtual {v0, v2}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v2

    sget v3, Lgc$f;->contentPanel:I

    invoke-virtual {v0, v3}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v3

    sget v4, Lgc$f;->buttonPanel:I

    invoke-virtual {v0, v4}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v4

    sget v5, Lgc$f;->customPanel:I
    ...
    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/view/View;
    ...
    :cond_4
    iget-object v9, p1, Landroid/support/v7/app/AlertController;->a:Landroid/view/Window;
    ...
    iget-object v8, p1, Landroid/support/v7/app/AlertController;->a:Landroid/view/Window;

    sget v11, Lgc$f;->custom:I
    ...
    iget-boolean v5, p1, Landroid/support/v7/app/AlertController;->a:Z

    if-eqz v5, :cond_6

    iget v5, p1, Landroid/support/v7/app/AlertController;->c:I

    iget v11, p1, Landroid/support/v7/app/AlertController;->d:I

    iget v12, p1, Landroid/support/v7/app/AlertController;->e:I

    iget v13, p1, Landroid/support/v7/app/AlertController;->f:I

    invoke-virtual {v8, v5, v11, v12, v13}, Landroid/widget/FrameLayout;->setPadding(IIII)V

    :cond_6
    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ListView;
    ...
    iput v8, v5, Landroid/support/v7/widget/LinearLayoutCompat$LayoutParams;->a:F
    ...
    :cond_8
    :goto_3
    sget v5, Lgc$f;->topPanel:I

    invoke-virtual {v0, v5}, Landroid/view/ViewGroup;->findViewById(I)Landroid/view/View;

    move-result-object v5

    sget v8, Lgc$f;->contentPanel:I

    invoke-virtual {v0, v8}, Landroid/view/ViewGroup;->findViewById(I)Landroid/view/View;

    move-result-object v8

    sget v11, Lgc$f;->buttonPanel:I
    ...
    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/view/Window;

    sget v8, Lgc$f;->scrollView:I
    ...
    iput-object v5, p1, Landroid/support/v7/app/AlertController;->b:Landroid/widget/TextView;

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->b:Landroid/widget/TextView;

    if-eqz v5, :cond_b

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->b:Ljava/lang/CharSequence;

    if-eqz v5, :cond_9

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->b:Landroid/widget/TextView;

    iget-object v8, p1, Landroid/support/v7/app/AlertController;->b:Ljava/lang/CharSequence;
    ...
    iget-object v8, p1, Landroid/support/v7/app/AlertController;->b:Landroid/widget/TextView;
    ...
    iget-object v11, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ListView;
    ...
    iput-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/Button;

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/Button;

    iget-object v8, p1, Landroid/support/v7/app/AlertController;->a:Landroid/view/View$OnClickListener;

    invoke-virtual {v5, v8}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->c:Ljava/lang/CharSequence;
    ...
    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p1, Landroid/support/v7/app/AlertController;->c:Ljava/lang/CharSequence;
    ...
    iget v8, p1, Landroid/support/v7/app/AlertController;->a:I

    iget v11, p1, Landroid/support/v7/app/AlertController;->a:I

    invoke-virtual {v5, v7, v7, v8, v11}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/Button;

    iget-object v8, p1, Landroid/support/v7/app/AlertController;->a:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v8, p1, Landroid/support/v7/app/AlertController;->b:Landroid/widget/Button;

    iget-object v8, p1, Landroid/support/v7/app/AlertController;->b:Landroid/widget/Button;

    iget-object v11, p1, Landroid/support/v7/app/AlertController;->a:Landroid/view/View$OnClickListener;
    ...
    iget-object v8, p1, Landroid/support/v7/app/AlertController;->b:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v11, p1, Landroid/support/v7/app/AlertController;->d:Ljava/lang/CharSequence;
    ...
    iget v12, p1, Landroid/support/v7/app/AlertController;->a:I

    invoke-virtual {v8, v7, v7, v11, v12}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v8, p1, Landroid/support/v7/app/AlertController;->b:Landroid/widget/Button;

    iget-object v11, p1, Landroid/support/v7/app/AlertController;->b:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v8, p1, Landroid/support/v7/app/AlertController;->c:Landroid/widget/Button;

    iget-object v8, p1, Landroid/support/v7/app/AlertController;->c:Landroid/widget/Button;
    ...
    iget-object v11, p1, Landroid/support/v7/app/AlertController;->e:Ljava/lang/CharSequence;
    ...
    iget-object v8, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/Button;

    iget-object v11, p1, Landroid/support/v7/app/AlertController;->a:Landroid/graphics/drawable/Drawable;
    ...
    sget v12, Lgc$a;->alertDialogCenterButtons:I
    ...
    :cond_17
    iget-object v5, p1, Landroid/support/v7/app/AlertController;->b:Landroid/view/View;
    ...
    iput-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ImageView;

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Ljava/lang/CharSequence;
    ...
    iget-boolean v5, p1, Landroid/support/v7/app/AlertController;->b:Z

    if-eqz v5, :cond_1b

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/view/Window;

    sget v8, Lgc$f;->alertTitle:I
    ...
    iput-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/TextView;

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/TextView;

    iget-object v8, p1, Landroid/support/v7/app/AlertController;->a:Ljava/lang/CharSequence;

    invoke-virtual {v5, v8}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget v5, p1, Landroid/support/v7/app/AlertController;->g:I

    if-eqz v5, :cond_19

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ImageView;

    iget v8, p1, Landroid/support/v7/app/AlertController;->g:I
    ...
    :cond_19
    iget-object v5, p1, Landroid/support/v7/app/AlertController;->d:Landroid/graphics/drawable/Drawable;

    if-eqz v5, :cond_1a

    iget-object v5, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ImageView;

    iget-object v8, p1, Landroid/support/v7/app/AlertController;->d:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ImageView;

    invoke-virtual {v8}, Landroid/widget/ImageView;->getPaddingLeft()I

    move-result v8

    iget-object v9, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ImageView;

    invoke-virtual {v9}, Landroid/widget/ImageView;->getPaddingTop()I

    move-result v9

    iget-object v12, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ImageView;

    invoke-virtual {v12}, Landroid/widget/ImageView;->getPaddingRight()I

    move-result v12

    iget-object v13, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ImageView;
    ...
    sget v8, Lgc$f;->textSpacerNoButtons:I
    ...
    iget-object v8, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ListView;
    ...
    :cond_22
    :goto_10
    sget v8, Lgc$f;->titleDividerNoCustom:I
    ...
    sget v2, Lgc$f;->textSpacerNoTitle:I
    ...
    :cond_24
    iget-object v2, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ListView;
    ...
    invoke-virtual {v2, v5, v4}, Landroid/support/v7/app/AlertController$RecycleListView;->setHasDecor(ZZ)V

    :cond_25
    if-nez v0, :cond_30

    iget-object v0, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ListView;
    ...
    iget-object v4, p1, Landroid/support/v7/app/AlertController;->a:Landroid/view/Window;

    sget v5, Lgc$f;->scrollIndicatorUp:I
    ...
    sget v7, Lgc$f;->scrollIndicatorDown:I
    ...
    invoke-static {v0, v2}, Lem;->d(Landroid/view/View;I)V
    ...
    :cond_2c
    iget-object v0, p1, Landroid/support/v7/app/AlertController;->b:Ljava/lang/CharSequence;
    ...
    iget-object v2, p1, Landroid/support/v7/app/AlertController;->a:Landroid/widget/ListAdapter;
    ...
    iget p1, p1, Landroid/support/v7/app/AlertController;->h:I
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, Lfs;->a:Landroid/support/v7/app/AlertController;
    ...
    :cond_1
    invoke-super {p0, p1, p2}, Lfw;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public final onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    :cond_1
    invoke-super {p0, p1, p2}, Lfw;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-super {p0, p1}, Lfw;->setTitle(Ljava/lang/CharSequence;)V
