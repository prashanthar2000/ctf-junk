public class android.support.v7.widget.AppCompatAutoCompleteTextView extends android.widget.AutoCompleteTextView implements el {
	 /* # interfaces */
	 /* # static fields */
	 ...
	 private final hz a;
	 /* # direct methods */
	 static android.support.v7.widget.AppCompatAutoCompleteTextView ( ) {
		 /* .locals 3 */
	 ...
	 public android.support.v7.widget.AppCompatAutoCompleteTextView ( ) {
		 /* .locals 1 */
	 ...
	 public android.support.v7.widget.AppCompatAutoCompleteTextView ( ) {
		 ...
		 (( android.support.v7.widget.AppCompatAutoCompleteTextView ) p0 ).getContext ( ); // invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->getContext()Landroid/content/Context;
		 v0 = android.support.v7.widget.AppCompatAutoCompleteTextView.a;
		 int v1 = 0; // const/4 v1, 0x0
		 ip .a ( p1,p2,v0,p3,v1 );
		 ...
		 if ( v0 != null) { // if-eqz v0, :cond_0
			 ...
			 (( android.support.v7.widget.AppCompatAutoCompleteTextView ) p0 ).setDropDownBackgroundDrawable ( v0 ); // invoke-virtual {p0, v0}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
		 } // :cond_0
		 p1 = this.a;
	 ...
	 public void setDropDownBackgroundResource ( Integer p0 ) {
		 ...
		 (( android.support.v7.widget.AppCompatAutoCompleteTextView ) p0 ).getContext ( ); // invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->getContext()Landroid/content/Context;
		 gd .a ( v0,p1 );
		 (( android.support.v7.widget.AppCompatAutoCompleteTextView ) p0 ).setDropDownBackgroundDrawable ( p1 ); // invoke-virtual {p0, p1}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
		 return;
	 } // .end method
