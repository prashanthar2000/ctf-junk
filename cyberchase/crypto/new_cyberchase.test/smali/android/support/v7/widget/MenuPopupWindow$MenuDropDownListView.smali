...
.method public final bridge synthetic a(IIIII)I
    ...
    invoke-super/range {p0 .. p5}, Lie;->a(IIIII)I
...
.method public final bridge synthetic a(Landroid/view/MotionEvent;I)Z
    ...
    invoke-super {p0, p1, p2}, Lie;->a(Landroid/view/MotionEvent;I)Z
...
.method public bridge synthetic hasFocus()Z
    ...
    invoke-super {p0}, Lie;->hasFocus()Z
...
.method public bridge synthetic hasWindowFocus()Z
    ...
    invoke-super {p0}, Lie;->hasWindowFocus()Z
...
.method public bridge synthetic isFocused()Z
    ...
    invoke-super {p0}, Lie;->isFocused()Z
...
.method public bridge synthetic isInTouchMode()Z
    ...
    invoke-super {p0}, Lie;->isInTouchMode()Z
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->a:Lih;
    ...
    invoke-virtual {v0, v3}, Lgy;->a(I)Lhb;

    move-result-object v2

    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->a:Landroid/view/MenuItem;

    if-eq v1, v2, :cond_3

    iget-object v0, v0, Lgy;->a:Lgz;

    if-eqz v1, :cond_2

    iget-object v3, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->a:Lih;

    invoke-interface {v3, v0, v1}, Lih;->a(Lgz;Landroid/view/MenuItem;)V

    :cond_2
    iput-object v2, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->a:Landroid/view/MenuItem;

    if-eqz v2, :cond_3

    iget-object v1, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->a:Lih;

    invoke-interface {v1, v0, v2}, Lih;->b(Lgz;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/ListMenuItemView;->getItemData()Lhb;
    ...
    iget-object p1, p1, Lgy;->a:Lgz;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Lgz;->a(Z)V
...
.method public setHoverListener(Lih;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->a:Lih;
