...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lzf;->q:Landroid/graphics/Matrix;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lzf;->c:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lzf;->n:Ljava/lang/String;

    iput-object v0, p0, Lzf;->o:Ljava/lang/Boolean;

    new-instance v0, Lu7;

    invoke-direct {v0}, Lu7;-><init>()V

    iput-object v0, p0, Lzf;->p:Lu7;

    new-instance v0, Lwf;

    invoke-direct {v0}, Lwf;-><init>()V

    iput-object v0, p0, Lzf;->h:Lwf;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lzf;->a:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lzf;->b:Landroid/graphics/Path;
...
.method public constructor <init>(Lzf;)V
    ...
    iget-object v2, p1, Lzf;->h:Lwf;

    invoke-direct {v1, v2, v0}, Lwf;-><init>(Lwf;Lu7;)V

    iput-object v1, p0, Lzf;->h:Lwf;

    new-instance v0, Landroid/graphics/Path;

    iget-object v1, p1, Lzf;->a:Landroid/graphics/Path;
    ...
    iget-object v1, p1, Lzf;->b:Landroid/graphics/Path;
    ...
    iget-object v0, p1, Lzf;->n:Ljava/lang/String;
    ...
    iget-object v1, p0, Lzf;->p:Lu7;

    invoke-virtual {v1, v0, p0}, Lb8;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    iget-object p1, p1, Lzf;->o:Ljava/lang/Boolean;

    iput-object p1, p0, Lzf;->o:Ljava/lang/Boolean;
...
# virtual methods
.method public final a(Lwf;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    .locals 17
    ...
    iget-object v0, v8, Lwf;->a:Landroid/graphics/Matrix;
    ...
    iget-object v1, v8, Lwf;->j:Landroid/graphics/Matrix;
    ...
    :goto_0
    iget-object v0, v8, Lwf;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, v8, Lwf;->a:Landroid/graphics/Matrix;
    ...
    invoke-virtual/range {v0 .. v6}, Lzf;->a(Lwf;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    iget-object v6, v8, Lwf;->a:Landroid/graphics/Matrix;

    iget-object v13, v7, Lzf;->c:Landroid/graphics/Matrix;
    ...
    .line 3
    iget-object v6, v2, Lzf;->a:Landroid/graphics/Path;
    ...
    iget-object v13, v0, Lyf;->a:[Laa;

    if-eqz v13, :cond_3

    invoke-static {v13, v6}, Laa;->b([Laa;Landroid/graphics/Path;)V

    .line 5
    :cond_3
    iget-object v6, v2, Lzf;->a:Landroid/graphics/Path;

    iget-object v13, v2, Lzf;->b:Landroid/graphics/Path;
    ...
    iget-object v4, v2, Lzf;->b:Landroid/graphics/Path;
    ...
    iget-object v0, v2, Lzf;->b:Landroid/graphics/Path;

    iget-object v4, v2, Lzf;->c:Landroid/graphics/Matrix;
    ...
    iget-object v14, v2, Lzf;->f:Landroid/graphics/PathMeasure;
    ...
    iput-object v14, v2, Lzf;->f:Landroid/graphics/PathMeasure;

    :cond_7
    iget-object v14, v2, Lzf;->f:Landroid/graphics/PathMeasure;

    iget-object v15, v2, Lzf;->a:Landroid/graphics/Path;
    ...
    iget-object v15, v2, Lzf;->f:Landroid/graphics/PathMeasure;

    const/4 v11, 0x1

    invoke-virtual {v15, v13, v14, v6, v11}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    iget-object v13, v2, Lzf;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v11, v2, Lzf;->e:Landroid/graphics/Paint;
    ...
    iput-object v11, v2, Lzf;->e:Landroid/graphics/Paint;
    ...
    .line 8
    iget-object v4, v4, Lr9;->a:Landroid/graphics/Shader;

    .line 9
    iget-object v13, v2, Lzf;->c:Landroid/graphics/Matrix;
    ...
    invoke-static {v4, v13}, Lcg;->a(IF)I
    ...
    iget-object v11, v2, Lzf;->d:Landroid/graphics/Paint;
    ...
    iput-object v11, v2, Lzf;->d:Landroid/graphics/Paint;
    ...
    iget-object v13, v0, Lvf;->o:Landroid/graphics/Paint$Join;
    ...
    :cond_13
    iget-object v13, v0, Lvf;->n:Landroid/graphics/Paint$Cap;
    ...
    invoke-static {v4, v6}, Lcg;->a(IF)I
...
.method public getAlpha()F
    ...
    invoke-virtual {p0}, Lzf;->getRootAlpha()I
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0, p1}, Lzf;->setRootAlpha(I)V
