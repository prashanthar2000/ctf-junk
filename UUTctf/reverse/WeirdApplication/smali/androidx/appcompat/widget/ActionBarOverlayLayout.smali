...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->k(Landroid/content/Context;)V

    new-instance p1, Lsb;

    invoke-direct {p1}, Lsb;-><init>()V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lsb;
...
.method public fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Lbc;->g(Landroid/view/View;)I
    ...
    invoke-virtual/range {v1 .. v7}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->g(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    invoke-static {p0, p1, v1}, Ll7;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lsb;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Ls5;
...
.method public l(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Ls5;
...
.method public n()V
    ...
    .line 2
    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Ls5;
...
.method public o(Landroid/view/Menu;Lm3$a;)V
    .locals 5
    ...
    .line 1
    iget-object v1, v0, Lf7;->n:Le4;

    if-nez v1, :cond_0

    new-instance v1, Le4;

    iget-object v2, v0, Lf7;->a:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v2}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2}, Le4;-><init>(Landroid/content/Context;)V

    iput-object v1, v0, Lf7;->n:Le4;

    :cond_0
    iget-object v1, v0, Lf7;->n:Le4;

    .line 2
    iput-object p2, v1, Le4;->f:Lm3$a;

    .line 3
    iget-object p2, v0, Lf7;->a:Landroidx/appcompat/widget/Toolbar;
    ...
    .line 4
    iget-object v0, p2, Landroidx/appcompat/widget/Toolbar;->b:Landroidx/appcompat/widget/ActionMenuView;
    ...
    .line 6
    iget-object v2, p2, Landroidx/appcompat/widget/Toolbar;->K:Le4;

    invoke-virtual {v0, v2}, Lz2;->u(Lm3;)V
    ...
    :cond_3
    iget-object v0, p2, Landroidx/appcompat/widget/Toolbar;->L:Landroidx/appcompat/widget/Toolbar$d;
    ...
    iput-object v0, p2, Landroidx/appcompat/widget/Toolbar;->L:Landroidx/appcompat/widget/Toolbar$d;

    :cond_4
    const/4 v0, 0x1

    .line 7
    iput-boolean v0, v1, Le4;->r:Z

    if-eqz p1, :cond_5

    .line 8
    iget-object v0, p2, Landroidx/appcompat/widget/Toolbar;->k:Landroid/content/Context;

    invoke-virtual {p1, v1, v0}, Lz2;->b(Lm3;Landroid/content/Context;)V

    iget-object v0, p2, Landroidx/appcompat/widget/Toolbar;->L:Landroidx/appcompat/widget/Toolbar$d;

    iget-object v2, p2, Landroidx/appcompat/widget/Toolbar;->k:Landroid/content/Context;

    invoke-virtual {p1, v0, v2}, Lz2;->b(Lm3;Landroid/content/Context;)V
    ...
    invoke-virtual {v1, p1, v2}, Le4;->j(Landroid/content/Context;Lz2;)V

    iget-object p1, p2, Landroidx/appcompat/widget/Toolbar;->L:Landroidx/appcompat/widget/Toolbar$d;

    .line 9
    iget-object v3, p1, Landroidx/appcompat/widget/Toolbar$d;->b:Lz2;

    if-eqz v3, :cond_6

    iget-object v4, p1, Landroidx/appcompat/widget/Toolbar$d;->c:Lc3;

    if-eqz v4, :cond_6

    invoke-virtual {v3, v4}, Lz2;->d(Lc3;)Z

    :cond_6
    iput-object v2, p1, Landroidx/appcompat/widget/Toolbar$d;->b:Lz2;

    .line 10
    invoke-virtual {v1, v0}, Le4;->h(Z)V

    iget-object p1, p2, Landroidx/appcompat/widget/Toolbar;->L:Landroidx/appcompat/widget/Toolbar$d;

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/Toolbar$d;->h(Z)V

    :goto_0
    iget-object p1, p2, Landroidx/appcompat/widget/Toolbar;->b:Landroidx/appcompat/widget/ActionMenuView;

    iget v0, p2, Landroidx/appcompat/widget/Toolbar;->l:I

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ActionMenuView;->setPopupTheme(I)V

    iget-object p1, p2, Landroidx/appcompat/widget/Toolbar;->b:Landroidx/appcompat/widget/ActionMenuView;

    invoke-virtual {p1, v1}, Landroidx/appcompat/widget/ActionMenuView;->setPresenter(Le4;)V

    iput-object v1, p2, Landroidx/appcompat/widget/Toolbar;->K:Le4;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Lbc;->p(Landroid/view/View;)V
...
.method public onMeasure(II)V
    ...
    invoke-virtual/range {v6 .. v12}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->g(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    :cond_0
    invoke-virtual {p0, p3}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->p(F)Z
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lsb;
    ...
    .line 3
    iget-object p2, p1, Lj1;->u:Ln2;

    if-eqz p2, :cond_0

    invoke-virtual {p2}, Ln2;->a()V

    const/4 p2, 0x0

    iput-object p2, p1, Lj1;->u:Ln2;
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    .line 3
    iget-boolean p1, v4, Lj1;->r:Z

    if-nez p1, :cond_5

    iput-boolean v3, v4, Lj1;->r:Z

    invoke-virtual {v4, v3}, Lj1;->h(Z)V
    ...
    .line 5
    iget-boolean v1, p1, Lj1;->r:Z

    if-eqz v1, :cond_5

    iput-boolean v2, p1, Lj1;->r:Z

    invoke-virtual {p1, v3}, Lj1;->h(Z)V
...
.method public setIcon(I)V
    ...
    invoke-static {v1, p1}, Ll1;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    :goto_0
    iput-object p1, v0, Lf7;->e:Landroid/graphics/drawable/Drawable;
...
.method public setLogo(I)V
    ...
    .line 2
    :goto_0
    iput-object p1, v0, Lf7;->f:Landroid/graphics/drawable/Drawable;
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    .line 1
    iput-object p1, v0, Lf7;->l:Landroid/view/Window$Callback;
