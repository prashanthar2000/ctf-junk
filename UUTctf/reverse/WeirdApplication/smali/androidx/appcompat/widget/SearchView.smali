...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Lo;->SearchView:[I
    ...
    sget p2, Lo;->SearchView_layout:I

    sget p3, Ll;->abc_search_view:I

    invoke-virtual {v1, p2, p3}, Lb7;->j(II)I
    ...
    sget p1, Lk;->search_edit_frame:I
    ...
    sget p2, Lo;->SearchView_queryBackground:I

    invoke-virtual {v1, p2}, Lb7;->e(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-static {p1, p2}, Lbc;->r(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, Landroidx/appcompat/widget/SearchView;->t:Landroid/view/View;

    sget p2, Lo;->SearchView_submitBackground:I
    ...
    sget p2, Lo;->SearchView_searchIcon:I
    ...
    sget p2, Lo;->SearchView_goIcon:I
    ...
    sget p2, Lo;->SearchView_closeIcon:I
    ...
    sget p2, Lo;->SearchView_voiceIcon:I
    ...
    sget p1, Lo;->SearchView_searchHintIcon:I

    invoke-virtual {v1, p1}, Lb7;->e(I)Landroid/graphics/drawable/Drawable;
    ...
    sget v0, Lm;->abc_searchview_description_search:I

    invoke-virtual {p2, v0}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p2

    invoke-static {p1, p2}, Lb1;->q0(Landroid/view/View;Ljava/lang/CharSequence;)V

    sget p1, Lo;->SearchView_suggestionRowLayout:I

    sget p2, Ll;->abc_search_dropdown_item_icons_2line:I

    invoke-virtual {v1, p1, p2}, Lb7;->j(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/SearchView;->G:I

    sget p1, Lo;->SearchView_commitIcon:I

    invoke-virtual {v1, p1, v2}, Lb7;->j(II)I
    ...
    sget p1, Lo;->SearchView_iconifiedByDefault:I

    invoke-virtual {v1, p1, p3}, Lb7;->a(IZ)Z

    move-result p1

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/SearchView;->setIconifiedByDefault(Z)V

    sget p1, Lo;->SearchView_android_maxWidth:I

    const/4 p2, -0x1

    invoke-virtual {v1, p1, p2}, Lb7;->d(II)I
    ...
    :cond_0
    sget p1, Lo;->SearchView_defaultQueryHint:I

    invoke-virtual {v1, p1}, Lb7;->l(I)Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/SearchView;->K:Ljava/lang/CharSequence;

    sget p1, Lo;->SearchView_queryHint:I
    ...
    sget p1, Lo;->SearchView_android_imeOptions:I

    invoke-virtual {v1, p1, p2}, Lb7;->h(II)I
    ...
    :cond_1
    sget p1, Lo;->SearchView_android_inputType:I
    ...
    :cond_2
    sget p1, Lo;->SearchView_android_focusable:I
...
.method public A(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/SearchView;->S:Lzc;
...
.method public getSuggestionsAdapter()Lzc;
    .locals 1
...
.method public onMeasure(II)V
    ...
    .line 2
    invoke-super {p0, p1, p2}, Lb6;->onMeasure(II)V
...
.method public setSearchableInfo(Landroid/app/SearchableInfo;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SearchView;->S:Lzc;

    if-eqz p1, :cond_1

    invoke-virtual {p1, v2}, Lzc;->b(Landroid/database/Cursor;)V
    ...
    invoke-direct {p1, v3, p0, v4, v5}, Lw6;-><init>(Landroid/content/Context;Landroidx/appcompat/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object p1, p0, Landroidx/appcompat/widget/SearchView;->S:Lzc;
...
.method public setSuggestionsAdapter(Lzc;)V
    .locals 1
...
.method public v(I)Z
    ...
    .line 1
    iget-object v2, p0, Landroidx/appcompat/widget/SearchView;->S:Lzc;

    .line 2
    iget-object v9, v2, Lzc;->d:Landroid/database/Cursor;
    ...
    .line 4
    invoke-static {v9, v2}, Lw6;->e(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v9, v2}, Lw6;->i(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    invoke-static {v9, v4}, Lw6;->i(Landroid/database/Cursor;I)Ljava/lang/String;
...
.method public w(I)Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SearchView;->S:Lzc;

    .line 2
    iget-object v1, v1, Lzc;->d:Landroid/database/Cursor;
    ...
    invoke-virtual {p1, v1}, Lzc;->c(Landroid/database/Cursor;)Ljava/lang/CharSequence;
