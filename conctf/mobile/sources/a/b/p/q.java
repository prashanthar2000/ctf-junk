...
public class q {
    ...
    public final ProgressBar f161a;

    /* renamed from: b  reason: collision with root package name */
    public Bitmap f162b;

    public q(ProgressBar progressBar) {
        this.f161a = progressBar;
    }

    public void a(AttributeSet attributeSet, int i) {
        x0 a2 = x0.a(this.f161a.getContext(), attributeSet, c, i, 0);
        Drawable c2 = a2.c(0);
        if (c2 != null) {
            ProgressBar progressBar = this.f161a;
        ...
        Drawable c3 = a2.c(1);
        if (c3 != null) {
            this.f161a.setProgressDrawable(a(c3, false));
        }
        a2.f186b.recycle();
    }
